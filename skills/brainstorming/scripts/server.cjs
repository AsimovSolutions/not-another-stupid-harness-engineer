...
const NASHE_VERSION = readNASHEVersion();
...
function brandMarkup() {
  // Local text only: the companion loads no remote assets and phones nowhere home.
  const text = 'NASHE v' + escapeHtmlText(NASHE_VERSION);
  return '<div class="brand"><a href="https://github.com/AsimovSolutions/not-another-stupid-harness-engineer">'
